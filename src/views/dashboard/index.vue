      ...
      <div class="left">
        ...
        <div class="panel">
          ...
          <div class="chart-container">
            ...
            <div class="chart">
              <!-- 图表 -->
              <!-- <div ref="social" style=" width: 100%; height:100%;background: red; " /> -->
              <social-charts style=" width: 100%; height:100%;"></social-charts>
            </div>
          </div>
        </div>
        <!-- 图表数据 -->
        <div class="panel">
          ...
          <div class="chart-container">
            ...
            <div class="chart">
              <!-- 图表 -->
              <!-- <div ref="provident" style=" width: 100%; height:100%;background: red; " /> -->
              <provident-charts></provident-charts>
            </div>
          </div>
        </div>
      </div>
...
import SocialCharts from './components/socialCharts.vue'
import ProvidentCharts from './components/providentCharts.vue'
